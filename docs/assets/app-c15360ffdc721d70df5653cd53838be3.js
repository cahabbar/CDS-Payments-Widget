...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("cds-payments-widget/app").default.create({name:"cds-payments-widget",version:"0.0.0+1d07784f"})
