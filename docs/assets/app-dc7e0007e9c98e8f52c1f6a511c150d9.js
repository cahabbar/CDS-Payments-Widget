...
case"myAction":p("case myAction"),console.log("Value of CDS.cdsProcess.cdsResponse "+CDS.cdsProcess.cdsResponse.respCode+" "+CDS.cdsProcess.cdsResponse.cardType+" "+CDS.cdsProcess.cdsResponse.cipher),console.log("\n\n\nmyAction",t.m[0],t.m[1],"\n\n\nmyAction")
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("cds-payments-widget/app").default.create({name:"cds-payments-widget",version:"0.0.0+d2b721e5"})
