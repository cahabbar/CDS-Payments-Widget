...
function n(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function i(e,t){switch(t.type){case"POSTS:FETCH_API":return e
case"POSTS:FILTER_POSTS":return e.filter===t.author?o({},e,{filter:void 0}):o({},e,{filter:t.author})
case"myAction":c("case myAction"),console.log("myAction",{state:e},{action:t},"\n\n\nmyAction")
var r=e.configs,i=r.cardInfo,a=i[t.m[0]],u=o({},e,{configs:o({},r,{cardInfo:o({},i,n({},t.m[0],o({},a,{value:t.m[2].target.value,touched:!0})))})})
return console.log("\n\n\n stateToRet","action.m[0]",t.m[0],"action.m[1]",t.m[1],"action.m[2].target.value",t.m[2].target.value,"\nstateToRet",{stateToRet:u},"\nstate\n\n"),u
...
case"saveNewConfigName":var l=e.newConfigName
return o({},e,n({},l.name,{name:l.name,value:l.value}))
case"saveNewConfig":var p=e.savedConfigs,d=e.Visa,f=e.MasterCard,h=e.AmericanExpress,m=e.DiscoverCard,y=e.DinersClub,g=e.JCB,v=e.CVC,b=e.nameOnCard,_=e.billMeToggle,w=e.billMe,x=e.credit,E=e.wallet,j=e.AlternativePayments
return o({},e,{savedConfigs:o({},p,n({},t.m[0],{name:t.m[0],Visa:d,MasterCard:f,AmericanExpress:h,DiscoverCard:m,DinersClub:y,JCB:g,CVC:v,nameOnCard:b,billMeToggle:_,billMe:w,credit:x,wallet:E,AlternativePayments:j}))})
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("cds-payments-widget/app").default.create({name:"cds-payments-widget",version:"0.0.0+063bc426"})
