...
profileDomain() {
    if [ "cdsg-prod" = "$AWS_PROFILE" ]; then
        ...
        export TF_VAR_acm_cert_arn_main="arn:aws:acm:us-east-1:631739919048:certificate/94f4eaed-a23e-4fee-8772-3a5c43f377c7"
        export TF_VAR_acm_cert_arn_other="arn:aws:acm:us-east-1:631739919048:certificate/7b9b2531-8324-4fcc-9f4f-9654db55683d"
